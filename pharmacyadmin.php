...
<div class="container text-center">
  <a href="login.php"><h2 class="my-5">Admin Dashboard</h2></a>  
    <div class="dashboard-container">
        ...
        <div class="dashboard-card">
            <div class="card-body">
                <h5>View Suggestions</h5>
                <p>View comments and suggestions</p>
                <a href="View_Suggestion.php" class="btn btn-green btn-block">Go to Suggestions</a>
            </div>
        </div>
    </div>
</div>
